...
enum cortex_m_impl_part {
	...
	STAR_MC1_PARTNO      = ARM_MAKE_CPUID(ARM_IMPLEMENTOR_ARM_CHINA, 0x132), /* ARM China Star Processor Tech. Manual */
	ARM_STAR_MC1_PARTNO  = ARM_MAKE_CPUID(ARM_IMPLEMENTOR_ARM, 0x132), /* FIXME - confirm implementor! */
